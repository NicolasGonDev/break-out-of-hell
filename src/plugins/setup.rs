use crate::{
    plugins,
    systems::{
        check_for_collisions, esc_exit, move_ball, move_player, spawn_ball, spawn_ball2,
        spawn_bricks, spawn_camera, spawn_player, spawn_walls,
    },
};
...
impl Plugin for SetupPlugin {
    fn build(&self, app: &mut App) {
        app.add_plugins((DefaultPlugins.set(plugins::window_plugin()),))
            ...
            .add_systems(Startup, spawn_ball2)
